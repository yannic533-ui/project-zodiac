  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-sm text-zinc-500 max-w-xl">
        Only one event can be active globally at a time. Route uses your active
        bars only; set order for the hunt.
      </p>
      ...
      >
        ...
        />
        <div>
          <div className="text-xs text-zinc-500 mb-2">Route (your active bars)</div>
